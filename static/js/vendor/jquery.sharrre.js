...
;(function ( $, window, document, undefined ) {
  ...
  urlJson = {
    ...
    facebook: "https://graph.facebook.com/v2.5/{url}?access_token=EAAVICALZABt0BACS3ZCvAfEuH4vNH2XeqaqVQIekpMw9dyBxxjggYSqyVFmzfVPEfRpWLHt0bSDtIx9vdfIxNhTgxZCl3u5IeNxJZBcGtDn9KZBEoPx5g8tKM5LHaZCfNTBYEvkZC8aKwryhDNiWCbHuQ2VEbtPENQf9Nv6mQLyWQZDZD",
  ...
  Plugin.prototype.getSocialJson = function (name) {
    ...
    if(url != '' && self.options.urlCurl !== ''){  //urlCurl = '' if you don't want to used PHP script but used social button
      $.getJSON(url, function(json){
        ...
        //  fbshares = parseInt(json.data[0].total_count, 10);
        else if(json.share && json.share && typeof json.share.share_count !== "undefined"){ //Facebook total count
          fbshares = parseInt(json.share.share_count, 10);
          if(fbshares < 2000){ //facebook old api bug
            count += fbshares;
          }
        }     
