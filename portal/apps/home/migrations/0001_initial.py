...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomeArticle'
        db.create_table('home_homearticle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Article'], unique=True)),
        ...
        db.send_create_signal('home', ['HomeArticle'])
        ...
        db.create_table('home_home', (
            ...
            ('edition', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='homes', null=True, to=orm['core.Edition'])),
        ))
        ...
        db.create_table('home_recentnews', (
            ...
            ('home', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recent', to=orm['home.Home'])),
        ))
        ...
        db.create_table('home_module', (
            ...
            ('article_1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='module_1', null=True, to=orm['home.HomeArticle'])),
            ('article_2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='module_2', null=True, to=orm['home.HomeArticle'])),
            ('article_3', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='module_3', null=True, to=orm['home.HomeArticle'])),
            ('article_4', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='module_4', null=True, to=orm['home.HomeArticle'])),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'HomeArticle'
        db.delete_table('home_homearticle')
    ...
    models = {
        ...
        'core.article': {
            ...
            'date_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 5, 16, 0, 0)'}),
        ...
        'core.articlerel': {
            'Meta': {'object_name': 'ArticleRel'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Article']"}),
            'cols': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '6', 'null': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': 'None', 'null': 'True'}),
            'rows': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'null': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Section']"}),
            'style': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
        ...
        'core.edition': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 5, 16, 0, 0)'}),
        ...
        'home.home': {
            'Meta': {'ordering': "('-date',)", 'object_name': 'Home'},
            'cover': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'was_cover_on'", 'to': "orm['home.HomeArticle']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 5, 16, 0, 0)', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'edition': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'homes'", 'null': 'True', 'to': "orm['core.Edition']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'home.homearticle': {
        ...
        'home.homesectionarticle': {
            'Meta': {'ordering': "('order', '-article__date_published', 'article__headline')", 'object_name': 'HomeSectionArticle', '_ormbases': ['home.TopArticle']},
            'home': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articulos en secciones'", 'to': "orm['home.Home']"}),
            'toparticle_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['home.TopArticle']", 'unique': 'True', 'primary_key': 'True'})
        },
        'home.hometoparticle': {
            'Meta': {'ordering': "('order', '-article__date_published', 'article__headline')", 'object_name': 'HomeTopArticle', '_ormbases': ['home.TopArticle']},
            'home': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'destacados'", 'to': "orm['home.Home']"}),
            'toparticle_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['home.TopArticle']", 'unique': 'True', 'primary_key': 'True'})
        },
        'home.module': {
            'Meta': {'ordering': "('home', 'order', 'date_created')", 'object_name': 'Module'},
            'article_1': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'module_1'", 'null': 'True', 'to': "orm['home.HomeArticle']"}),
            'article_2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'module_2'", 'null': 'True', 'to': "orm['home.HomeArticle']"}),
            'article_3': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'module_3'", 'null': 'True', 'to': "orm['home.HomeArticle']"}),
            'article_4': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'module_4'", 'null': 'True', 'to': "orm['home.HomeArticle']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'home': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'modules'", 'to': "orm['home.Home']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'home.recentnews': {
            ...
            'home': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recent'", 'to': "orm['home.Home']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'home.toparticle': {
            'Meta': {'ordering': "('order', '-article__date_published', 'article__headline')", 'object_name': 'TopArticle'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Article']"}),
            'display': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lead': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
