...
class Publication(Model):
    ...
    youtube_video = ForeignKey(
        YouTubeVideo, on_delete=SET_NULL, blank=True, null=True, verbose_name='Video en la portada principal'
    )
...
class Category(Model):
    ...
    youtube_video = ForeignKey(
        YouTubeVideo, on_delete=SET_NULL, blank=True, null=True, verbose_name='Video en la portada de área'
    )
