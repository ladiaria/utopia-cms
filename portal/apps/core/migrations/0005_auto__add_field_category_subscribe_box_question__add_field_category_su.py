...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.subscribe_box_question'
        db.add_column(u'core_category', 'subscribe_box_question',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.subscribe_box_nl_subscribe_auth'
        db.add_column(u'core_category', 'subscribe_box_nl_subscribe_auth',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.subscribe_box_nl_subscribe_anon'
        db.add_column(u'core_category', 'subscribe_box_nl_subscribe_anon',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.subscribe_box_question'
        db.delete_column(u'core_category', 'subscribe_box_question')

        # Deleting field 'Category.subscribe_box_nl_subscribe_auth'
        db.delete_column(u'core_category', 'subscribe_box_nl_subscribe_auth')

        # Deleting field 'Category.subscribe_box_nl_subscribe_anon'
        db.delete_column(u'core_category', 'subscribe_box_nl_subscribe_anon')
    ...
    models = {
        ...
        u'core.article': {
            ...
            'date_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2021, 1, 31, 0, 0)'}),
        ...
        u'core.edition': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2021, 1, 31, 0, 0)'}),
