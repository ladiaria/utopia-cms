...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.exclude_from_top_menu'
        db.add_column(u'core_category', 'exclude_from_top_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.exclude_from_top_menu'
        db.delete_column(u'core_category', 'exclude_from_top_menu')
    ...
    models = {
        ...
        u'core.article': {
            ...
            'date_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2021, 6, 15, 0, 0)'}),
        ...
        u'core.category': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'exclude_from_top_menu': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'core.categoryhomearticle': {
            'Meta': {'ordering': "('position',)", 'object_name': 'CategoryHomeArticle'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'home_articles'", 'to': u"orm['core.Article']"}),
        ...
        u'core.edition': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2021, 6, 15, 0, 0)'}),
