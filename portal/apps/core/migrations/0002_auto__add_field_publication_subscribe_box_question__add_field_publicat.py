...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.subscribe_box_question'
        db.add_column(u'core_publication', 'subscribe_box_question',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.subscribe_box_nl_subscribe_auth'
        db.add_column(u'core_publication', 'subscribe_box_nl_subscribe_auth',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.subscribe_box_nl_subscribe_anon'
        db.add_column(u'core_publication', 'subscribe_box_nl_subscribe_anon',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.icon'
        db.add_column(u'core_publication', 'icon',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.icon_png'
        db.add_column(u'core_publication', 'icon_png',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.icon_png_16'
        db.add_column(u'core_publication', 'icon_png_16',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.icon_png_32'
        db.add_column(u'core_publication', 'icon_png_32',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.apple_touch_icon_180'
        db.add_column(u'core_publication', 'apple_touch_icon_180',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.apple_touch_icon_192'
        db.add_column(u'core_publication', 'apple_touch_icon_192',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.apple_touch_icon_512'
        db.add_column(u'core_publication', 'apple_touch_icon_512',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.open_graph_image'
        db.add_column(u'core_publication', 'open_graph_image',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.subscribe_box_question'
        db.delete_column(u'core_publication', 'subscribe_box_question')

        # Deleting field 'Publication.subscribe_box_nl_subscribe_auth'
        db.delete_column(u'core_publication', 'subscribe_box_nl_subscribe_auth')

        # Deleting field 'Publication.subscribe_box_nl_subscribe_anon'
        db.delete_column(u'core_publication', 'subscribe_box_nl_subscribe_anon')

        # Deleting field 'Publication.icon'
        db.delete_column(u'core_publication', 'icon')

        # Deleting field 'Publication.icon_png'
        db.delete_column(u'core_publication', 'icon_png')

        # Deleting field 'Publication.icon_png_16'
        db.delete_column(u'core_publication', 'icon_png_16')

        # Deleting field 'Publication.icon_png_32'
        db.delete_column(u'core_publication', 'icon_png_32')

        # Deleting field 'Publication.apple_touch_icon_180'
        db.delete_column(u'core_publication', 'apple_touch_icon_180')

        # Deleting field 'Publication.apple_touch_icon_192'
        db.delete_column(u'core_publication', 'apple_touch_icon_192')

        # Deleting field 'Publication.apple_touch_icon_512'
        db.delete_column(u'core_publication', 'apple_touch_icon_512')

        # Deleting field 'Publication.open_graph_image'
        db.delete_column(u'core_publication', 'open_graph_image')
    ...
    models = {
        ...
        u'core.article': {
            ...
            'date_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 11, 11, 0, 0)'}),
        ...
        u'core.edition': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2020, 11, 11, 0, 0)'}),
