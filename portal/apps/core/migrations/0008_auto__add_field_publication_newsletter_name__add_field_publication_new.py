...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.newsletter_name'
        db.add_column(u'core_publication', 'newsletter_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.newsletter_tagline'
        db.add_column(u'core_publication', 'newsletter_tagline',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.newsletter_periodicity'
        db.add_column(u'core_publication', 'newsletter_periodicity',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.new_pill'
        db.add_column(u'core_publication', 'new_pill',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.newsletter_name'
        db.delete_column(u'core_publication', 'newsletter_name')

        # Deleting field 'Publication.newsletter_tagline'
        db.delete_column(u'core_publication', 'newsletter_tagline')

        # Deleting field 'Publication.newsletter_periodicity'
        db.delete_column(u'core_publication', 'newsletter_periodicity')

        # Deleting field 'Publication.new_pill'
        db.delete_column(u'core_publication', 'new_pill')
    ...
    models = {
        ...
        u'core.article': {
            ...
            'date_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2021, 5, 16, 0, 0)'}),
        ...
        u'core.edition': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2021, 5, 16, 0, 0)'}),
