...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.open_graph_image_width'
        db.add_column(u'core_publication', 'open_graph_image_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.open_graph_image_height'
        db.add_column(u'core_publication', 'open_graph_image_height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.publisher_logo'
        db.add_column(u'core_publication', 'publisher_logo',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.publisher_logo_width'
        db.add_column(u'core_publication', 'publisher_logo_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.publisher_logo_height'
        db.add_column(u'core_publication', 'publisher_logo_height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.open_graph_image_width'
        db.delete_column(u'core_publication', 'open_graph_image_width')

        # Deleting field 'Publication.open_graph_image_height'
        db.delete_column(u'core_publication', 'open_graph_image_height')

        # Deleting field 'Publication.publisher_logo'
        db.delete_column(u'core_publication', 'publisher_logo')

        # Deleting field 'Publication.publisher_logo_width'
        db.delete_column(u'core_publication', 'publisher_logo_width')

        # Deleting field 'Publication.publisher_logo_height'
        db.delete_column(u'core_publication', 'publisher_logo_height')
    ...
    models = {
        ...
        u'core.article': {
            ...
            'date_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 12, 23, 0, 0)'}),
        ...
        u'core.edition': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2020, 12, 23, 0, 0)'}),
