...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CategoryHomeArticle'
        db.create_table(u'core_categoryhomearticle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('home', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CategoryHome'])),
        ...
        db.send_create_signal(u'core', ['CategoryHomeArticle'])

        # Adding model 'CategoryHome'
        db.create_table(u'core_categoryhome', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='home', unique=True, to=orm['core.Category'])),
        ))
        db.send_create_signal(u'core', ['CategoryHome'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_module', (
            ...
            ('article_7', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_7', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ...
            ('article_6', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_6', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ('article_5', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_5', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ('article_4', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_4', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ('article_2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_2', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ('article_3', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_3', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ('article_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_1', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article_8', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_8', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
            ('article_9', self.gf('django.db.models.fields.related.ForeignKey')(related_name='module_9', null=True, to=orm['core.Article'], on_delete=models.SET_NULL, blank=True)),
        ))
        db.send_create_signal('core', ['Module'])

        # Deleting model 'CategoryHomeArticle'
        db.delete_table(u'core_categoryhomearticle')

        # Deleting model 'CategoryHome'
        db.delete_table(u'core_categoryhome')
    ...
    models = {
        ...
        u'core.article': {
            ...
            'date_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2021, 5, 24, 0, 0)'}),
        ...
        u'core.categoryhome': {
            'Meta': {'ordering': "('category',)", 'object_name': 'CategoryHome'},
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Article']", 'through': u"orm['core.CategoryHomeArticle']", 'symmetrical': 'False'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'home'", 'unique': 'True', 'to': u"orm['core.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'core.categoryhomearticle': {
            'Meta': {'object_name': 'CategoryHomeArticle'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Article']"}),
            'fixed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'home': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.CategoryHome']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.edition': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2021, 5, 24, 0, 0)'}),
        ...
        u'core.publication': {
            ...
            'newsletter_name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'newsletter_periodicity': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'newsletter_tagline': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
