    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='slug')),
                ('description', models.TextField(blank=True, null=True, verbose_name='descripci\xf3n')),
                ('contact', models.EmailField(blank=True, max_length=254, null=True, verbose_name="email")),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='fecha de creaci\xf3n')),
                ('home_order', models.PositiveSmallIntegerField(default=0, verbose_name='orden')),
