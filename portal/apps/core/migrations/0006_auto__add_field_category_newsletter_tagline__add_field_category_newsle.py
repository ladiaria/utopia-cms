...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.newsletter_tagline'
        db.add_column(u'core_category', 'newsletter_tagline',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.newsletter_periodicity'
        db.add_column(u'core_category', 'newsletter_periodicity',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.newsletter_tagline'
        db.delete_column(u'core_category', 'newsletter_tagline')

        # Deleting field 'Category.newsletter_periodicity'
        db.delete_column(u'core_category', 'newsletter_periodicity')
