...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscriber.days'
        db.delete_column(u'thedaily_subscriber', 'days')

        # Deleting field 'Subscriber.costumer_id'
        db.delete_column(u'thedaily_subscriber', 'costumer_id')

        # Adding field 'Subscriber.contact_id'
        db.add_column(u'thedaily_subscriber', 'contact_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Subscriber.days'
        db.add_column(u'thedaily_subscriber', 'days',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=5, null=True),
                      keep_default=False)

        # Adding field 'Subscriber.costumer_id'
        db.add_column(u'thedaily_subscriber', 'costumer_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Subscriber.contact_id'
        db.delete_column(u'thedaily_subscriber', 'contact_id')
    ...
    models = {
        ...
        u'core.edition': {
            ...
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2021, 6, 10, 0, 0)'}),
        ...
        u'thedaily.subscriber': {
            ...
            'contact_id': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'plan_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
