...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subscription_type', models.CharField(choices=[(b'DDIGM', 'Suscripci\xf3n digital'), (b'PAPYDIM', 'Suscripci\xf3n papel')], default=b'PAPYDIM', max_length=7, unique=True, verbose_name='tipo')),
