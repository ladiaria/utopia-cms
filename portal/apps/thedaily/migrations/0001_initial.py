    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription_type', models.CharField(choices=[(b'PAP', 'Edici\xf3n papel + Digital'), (b'DIG', 'Digital (Edici\xf3n web)')], default=b'DIG', max_length=3, verbose_name='suscripci\xf3n')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subscription_type', models.CharField(choices=[(b'DDIGM', 'Suscripci\xf3n Ilimitada'), (b'PAPYDIM', 'Suscripci\xf3n papel')], default=b'PAPYDIM', max_length=7, unique=True, verbose_name='tipo')),
