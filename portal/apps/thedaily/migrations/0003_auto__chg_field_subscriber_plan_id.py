...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscriber.plan_id'
        db.alter_column(u'thedaily_subscriber', 'plan_id', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Subscriber.plan_id'
        db.alter_column(u'thedaily_subscriber', 'plan_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        u'core.edition': {
            ...
            'date_published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2021, 4, 13, 0, 0)'}),
