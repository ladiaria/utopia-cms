...
from thedaily.views import (
    ...
    registered_users, amp_access_authorization, amp_access_pingback, amp_access_show_api, session_refresh,
    edicion_impresa, nlunsubscribe, welcome, nl_category_subscribe, nl_category_unsubscribe, notification_preview,
    phone_subscription, custom_api, nl_subscribe, discourse_sso, email_check_api, user_comments_api)
