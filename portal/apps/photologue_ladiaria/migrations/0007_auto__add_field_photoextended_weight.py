...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoExtended.weight'
        db.add_column('photologue_ladiaria_photoextended', 'weight',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoExtended.weight'
        db.delete_column('photologue_ladiaria_photoextended', 'weight')
    ...
    models = {
        ...
        'photologue_ladiaria.photoextended': {
            ...
            'weight': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'})
        }
    }
