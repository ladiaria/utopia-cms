...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoExtended.radius_length'
        db.add_column('photologue_ladiaria_photoextended', 'radius_length',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoExtended.radius_length'
        db.delete_column('photologue_ladiaria_photoextended', 'radius_length')
