    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallery', models.ForeignKey(on_delete=models.CASCADE, blank=True, verbose_name='gallery', null=True, help_text='Select a gallery to add these images to. Leave this empty to create a new gallery from the supplied title.', to='photologue.Gallery')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='photo',
            name='effect',
            field=models.ForeignKey(on_delete=models.CASCADE, blank=True, verbose_name='effect', null=True, to='photologue.PhotoEffect'),
            preserve_default=True,
        ),
        migrations.CreateModel(
            name='PhotoSize',
            fields=[
                ...
                ('effect', models.ForeignKey(on_delete=models.CASCADE, blank=True, verbose_name='photo effect', null=True, to='photologue.PhotoEffect')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='watermark',
            field=models.ForeignKey(on_delete=models.CASCADE, blank=True, verbose_name='watermark image', null=True, to='photologue.Watermark'),
            preserve_default=True,
        ),
    ]
