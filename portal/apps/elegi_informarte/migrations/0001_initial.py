...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Suscripcion'
        db.create_table('elegi_informarte_suscripcion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscriber', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thedaily.Subscriber'])),
            ('credencial_serie', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('credencial_numero', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal('elegi_informarte', ['Suscripcion'])


    def backwards(self, orm):
        # Deleting model 'Suscripcion'
        db.delete_table('elegi_informarte_suscripcion')
