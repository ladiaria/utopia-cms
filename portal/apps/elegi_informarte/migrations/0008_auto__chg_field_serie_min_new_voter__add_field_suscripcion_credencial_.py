...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Serie.min_new_voter'
        db.alter_column('elegi_informarte_serie', 'min_new_voter', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
        # Adding field 'Suscripcion.credencial_serie'
        db.add_column('elegi_informarte_suscripcion', 'credencial_serie',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='suscripciones', to=orm['elegi_informarte.Serie']),
                      keep_default=False)


        # Changing field 'Suscripcion.credencial_serie_fk'
        db.alter_column('elegi_informarte_suscripcion', 'credencial_serie_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['elegi_informarte.Serie']))
        # Adding unique constraint on 'Suscripcion', fields ['subscriber']
        db.create_unique('elegi_informarte_suscripcion', ['subscriber_id'])


        # Changing field 'Suscripcion.credencial_numero'
        db.alter_column('elegi_informarte_suscripcion', 'credencial_numero', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Suscripcion', fields ['subscriber']
        db.delete_unique('elegi_informarte_suscripcion', ['subscriber_id'])


        # Changing field 'Serie.min_new_voter'
        db.alter_column('elegi_informarte_serie', 'min_new_voter', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
        # Deleting field 'Suscripcion.credencial_serie'
        db.delete_column('elegi_informarte_suscripcion', 'credencial_serie_id')


        # Changing field 'Suscripcion.credencial_serie_fk'
        db.alter_column('elegi_informarte_suscripcion', 'credencial_serie_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elegi_informarte.Serie'], null=True))

        # Changing field 'Suscripcion.credencial_numero'
        db.alter_column('elegi_informarte_suscripcion', 'credencial_numero', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        'elegi_informarte.suscripcion': {
            'Meta': {'unique_together': "(('credencial_numero', 'credencial_serie_fk'),)", 'object_name': 'Suscripcion'},
            ...
            'credencial_serie_fk': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['elegi_informarte.Serie']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
