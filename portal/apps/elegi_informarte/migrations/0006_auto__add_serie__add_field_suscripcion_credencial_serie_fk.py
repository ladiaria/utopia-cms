...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Serie'
        db.create_table('elegi_informarte_serie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('serie', self.gf('django.db.models.fields.CharField')(unique=True, max_length=3)),
            ('min_new_voter', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
        ))
        db.send_create_signal('elegi_informarte', ['Serie'])

        # Adding field 'Suscripcion.credencial_serie_fk'
        db.add_column('elegi_informarte_suscripcion', 'credencial_serie_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elegi_informarte.Serie'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Serie'
        db.delete_table('elegi_informarte_serie')
    ...
    models = {
        ...
        'elegi_informarte.suscripcion': {
            ...
            'credencial_serie': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'credencial_serie_fk': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['elegi_informarte.Serie']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
