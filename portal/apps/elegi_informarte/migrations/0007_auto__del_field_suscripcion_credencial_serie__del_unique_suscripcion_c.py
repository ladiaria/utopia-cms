...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('elegi_informarte_suscripcion', ['credencial_numero', 'credencial_serie'])

        # Deleting field 'Suscripcion.credencial_serie'
        db.delete_column('elegi_informarte_suscripcion', 'credencial_serie')


    def backwards(self, orm):
        # Adding field 'Suscripcion.credencial_serie'
        db.add_column('elegi_informarte_suscripcion', 'credencial_serie',
                      self.gf('django.db.models.fields.CharField')(default='AAA', max_length=3),
                      keep_default=False)

        # Adding unique constraint on 'Suscripcion', fields ['credencial_numero', 'credencial_serie']
        db.create_unique('elegi_informarte_suscripcion', ['credencial_numero', 'credencial_serie'])
    ...
    models = {
        ...
        'elegi_informarte.serie': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'min_new_voter': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
            'serie': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '3'})
        },
        'elegi_informarte.suscripcion': {
            'Meta': {'object_name': 'Suscripcion'},
            'credencial_numero': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'credencial_serie_fk': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['elegi_informarte.Serie']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subscriber': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thedaily.Subscriber']"})
        },
        'photologue.agency': {
