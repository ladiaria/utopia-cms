...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Suscripcion', fields ['credencial_serie', 'credencial_numero']
        db.delete_unique('elegi_informarte_suscripcion', ['credencial_serie', 'credencial_numero'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Suscripcion', fields ['credencial_serie', 'credencial_numero']
        db.create_unique('elegi_informarte_suscripcion', ['credencial_serie', 'credencial_numero'])
