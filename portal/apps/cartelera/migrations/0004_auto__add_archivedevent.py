...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArchivedEvent'
        db.create_table('cartelera_archivedevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('access_type', self.gf('django.db.models.fields.CharField')(default='s', max_length=1)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('embed_content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('cartelera', ['ArchivedEvent'])


    def backwards(self, orm):
        # Deleting model 'ArchivedEvent'
        db.delete_table('cartelera_archivedevent')
    ...
    models = {
        ...
        'cartelera.archivedevent': {
            'Meta': {'object_name': 'ArchivedEvent'},
