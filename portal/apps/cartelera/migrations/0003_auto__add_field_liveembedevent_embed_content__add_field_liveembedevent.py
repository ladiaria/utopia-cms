...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LiveEmbedEvent.embed_content'
        db.add_column('cartelera_liveembedevent', 'embed_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LiveEmbedEvent.embed_chat'
        db.add_column('cartelera_liveembedevent', 'embed_chat',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LiveEmbedEvent.embed_content'
        db.delete_column('cartelera_liveembedevent', 'embed_content')

        # Deleting field 'LiveEmbedEvent.embed_chat'
        db.delete_column('cartelera_liveembedevent', 'embed_chat')
    ...
    models = {
        ...
        'cartelera.liveembedevent': {
            ...
            'embed_chat': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'embed_content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
