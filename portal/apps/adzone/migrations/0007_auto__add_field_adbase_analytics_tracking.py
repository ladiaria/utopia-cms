...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdBase.analytics_tracking'
        db.add_column('adzone_adbase', 'analytics_tracking',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdBase.analytics_tracking'
        db.delete_column('adzone_adbase', 'analytics_tracking')
