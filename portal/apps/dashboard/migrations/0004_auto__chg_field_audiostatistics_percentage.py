...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AudioStatistics.percentage'
        db.alter_column(u'dashboard_audiostatistics', 'percentage', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AudioStatistics.percentage'
        db.alter_column(u'dashboard_audiostatistics', 'percentage', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        u'dashboard.audiostatistics': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percentage': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
