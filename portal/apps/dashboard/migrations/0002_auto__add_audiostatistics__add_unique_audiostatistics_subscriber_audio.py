...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AudioStatistics'
        db.create_table(u'dashboard_audiostatistics', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscriber', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thedaily.Subscriber'])),
            ('audio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audiologue.Audio'])),
            ('percentage', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'dashboard', ['AudioStatistics'])

        # Adding unique constraint on 'AudioStatistics', fields ['subscriber', 'audio']
        db.create_unique(u'dashboard_audiostatistics', ['subscriber_id', 'audio_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AudioStatistics', fields ['subscriber', 'audio']
        db.delete_unique(u'dashboard_audiostatistics', ['subscriber_id', 'audio_id'])

        # Deleting model 'AudioStatistics'
        db.delete_table(u'dashboard_audiostatistics')
